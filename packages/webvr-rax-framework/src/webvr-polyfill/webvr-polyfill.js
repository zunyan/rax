...
WebVRPolyfill.prototype.isWebVRAvailable = function() {
  return 'getVRDisplays' in navigator || 'vr' in navigator;
};
...
WebVRPolyfill.prototype.enablePolyfill = function() {
  // Provide navigator.getVRDisplays and navigator.vr.getDisplays.

  var getVRDisplays = this.getVRDisplays.bind(this);
  navigator.vr = {
    getDisplays: getVRDisplays
  };
